    ...
    <div className="relative min-h-screen bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 pb-16">
      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        ...
        <div className="grid grid-cols-1 gap-8 mx-auto lg:grid-cols-2">
          <Card>
            <div className="p-8">
              <h3 className="text-xl font-bold text-zinc-100 mb-4">Background</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <Card>
              <div className="p-6">
                <h4 className="text-lg font-semibold text-zinc-100 mb-4">Tools & Technologies</h4>
                <ul className="space-y-2 text-zinc-400">
                  <li>• Git</li>
                  <li>• GitHub</li>
                  <li>• Docker</li>
        ...
        <div className="w-full h-px bg-zinc-800" />
        <div>
          <h3 className="text-2xl font-bold text-zinc-100 mb-6">Achievements</h3>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <Card>
              <div className="p-6">
                <h4 className="text-lg font-semibold text-zinc-100">NXP AIM 2025 - Regional Finalist</h4>
                <p className="mt-2 text-zinc-400">
                  Selected as regional finalist in NXP's Artificial Intelligence in Mobility competition. 
                  Competed in robotic treasure hunt challenges using ROS2, SLAM, and computer vision.
                </p>
                <Link
            ...
            <Card>
              <div className="p-6">
                <h4 className="text-lg font-semibold text-zinc-100">Qt Champion 2024 - 3rd Place</h4>
                <p className="mt-2 text-zinc-400">
                  Recognized by Qt Group as one of the top 3 performers among 100+ international teams 
                  in the global Qt-athon 2024 competition.
                </p>
                <Link
            ...
            <Card>
              <div className="p-6 md:col-span-2">
                <h4 className="text-lg font-semibold text-zinc-100">Embedded Systems Certification</h4>
                <p className="mt-2 text-zinc-400">
                  Completed C Programming fundamentals from Pyjamabrah course, taught by Google engineers 
                  Piyush Itankar and Mahmad Bharmal.
                </p>
                <Link
          ...
          <Card>
            <div className="p-6">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between">
                <div>
                  <h4 className="text-lg font-semibold text-zinc-100">Project Intern</h4>
                  <p className="text-zinc-300">FOSSEE, IIT Bombay</p>
                </div>
                <p className="text-sm text-zinc-400 mt-2 md:mt-0">Feb 2025 - May 2025</p>
              </div>
              <p className="mt-4 text-zinc-400">
                ...
                Enhanced the Qt/Python GUI's functionality and performance to improve user experience for 
                OpenModelica's specific simulation and model selection processes.
              </p>
            </div>
          </Card>
        </div>
